"""
This script is called by the plugin-wrapper, ansibleWorkflow.js, which passes down the
...
from ansibleWorkflow import ansibleWorkflow
...
plugin = ansibleWorkflow(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
