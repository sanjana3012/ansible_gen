"""
This script is called by the plugin-wrapper, playGenerator.js, which passes down the
...
plugin = playGenerator(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
