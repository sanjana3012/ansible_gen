"""
This script is called by the plugin-wrapper, inventoryFileGen.js, which passes down the
...
from inventoryFileGen import inventoryFileGen
...
plugin = inventoryFileGen(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
