"""
This script is called by the plugin-wrapper, PlaybookGenerator.js, which passes down the
...
from PlaybookGenerator import PlaybookGenerator
...
plugin = PlaybookGenerator(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
