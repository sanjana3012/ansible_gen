"""
This script is called by the plugin-wrapper, ansiblePlayStep.js, which passes down the
...
from ansiblePlayStep import ansiblePlayStep
...
plugin = ansiblePlayStep(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
